...
epoch_length = len(train_imgs) + len(val_imgs)
...
#	while True:
	while iter_num <= epoch_length:
		try:
			...
			print(f'Exception: {e}')
			print("train.py son exception e")            
			continue
